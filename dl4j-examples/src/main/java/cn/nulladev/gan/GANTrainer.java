...
public class GANTrainer {
    ...
    public static void train3() throws Exception{
        ComputationGraph net = new ComputationGraph(NetFactory.createBuilder3().build());
        net.init();
        net.setListeners(new ScoreIterationListener(100));
        ...
        for (int i=1; i<=100000; i++) {
            ...
            net.fit(dataSetG);
            if (i%10000==0) {
                net.save(new File("E:/Temp/hggan-"+(i)+".zip"), true);
            }
        }
    }
